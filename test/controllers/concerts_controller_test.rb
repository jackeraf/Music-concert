...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { artist: @concert.artist, city: @concert.city, date: @concert.date, description: @concert.description, done_at: @concert.done_at, price: @concert.price, venue: @concert.venue } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { artist: @concert.artist, city: @concert.city, date: @concert.date, description: @concert.description, done_at: @concert.done_at, price: @concert.price, venue: @concert.venue } }
